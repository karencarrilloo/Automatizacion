...
describe('Pruebas de Login', function () {
  ...
  //   try {
  //     await loginPage.ejecutarLogin(process.env.LOGIN_EMAIL,'Clave_Incorrecta_123','CP_LOGIN_002');

  //     // Esperar la alerta
  //     const alert = await driver.wait(until.elementLocated(By.css('div[data-growl="container"][role="alert"]')),30000
  //     );
